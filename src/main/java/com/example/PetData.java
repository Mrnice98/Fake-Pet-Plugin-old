...
public enum PetData {
    ...
    //COX----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    OLMLET("Olmlet","Olmlet", NpcID.OLMLET,ItemID.OLMLET,Lists.newArrayList(32697),1,7396,7395,7395,64,-1,-1,null,true,"The most cuddly Spawn of the Guardian in the Deep.","<Purples>R2xMVP:223+:July 17,2022"),
    PUPPADILE("Puppadile","Puppadile",NpcID.PUPPADILE,ItemID.PUPPADILE,Lists.newArrayList(32681),1,7417,7982,7982,45,-1,-1,null,true,"A puppy of a mutated guardian of Xeric.","<Killcount>RoyalRain:1063:Unknown"),
    ...
    PET_SMOKE_DEVIL("Pet Smoke Devil","Pet Smoke Devil",NpcID.SMOKE_DEVIL,ItemID.PET_SMOKE_DEVIL_22663,Lists.newArrayList(28442),1,1829,1828,1828,60,25,25,null,true,"Woah.","<Killcount>Suede:15380:April 19, 2021"),
    PET_SMOKE_DEVIL_6655("Pet Smoke Devil 6655","Pet Smoke Devil",NpcID.SMOKE_DEVIL_6639,ItemID.PET_SMOKE_DEVIL,Lists.newArrayList(36012),1,1829,1828,1828,35,25,25,null,true,"Woah.","<Killcount>Suede:15380:April 19, 2021"),
    ...
    ZILYANA_JR("Zilyana Jr.","Zilyana Jr.",NpcID.ZILYANA_JR,ItemID.PET_ZILYANA,Lists.newArrayList(27989,27937,27985,27968,27990),1,6966,6965,6965,60,30,30,null,false,"Somehow a junior even though she's named after her spawn mother!","<Killcount>Letsjjj:26472:January 17, 2022"),
    KRIL_TSUTSAROTH_JR("K'ril Tsutsaroth Jr.","K'ril Tsutsaroth Jr.",NpcID.KRIL_TSUTSAROTH_JR,ItemID.PET_KRIL_TSUTSAROTH,Lists.newArrayList(27683,27681,27692,27682,27690),1,6935,4070,4070,20,30,30,null,false,"Where did he even come from?","<Killcount>Xl3g3ndgOdX:21654:February 18, 2023"),
    ...
    TZREK_ZUK("TzRek-Zuk","TzRek-Zuk",NpcID.TZREKZUK,ItemID.TZREKZUK,Lists.newArrayList(34586),1,7975,7977,7977,18,30,30,null,true,"Not quite so fearsome anymore.","<Killcount>Oglong King:236:May 8, 2022"),

    //jad
    TZREK_JAD("TzRek-Jad","TzRek-Jad",NpcID.TZREKJAD,ItemID.TZREKJAD,Lists.newArrayList(9319),1,2650,5805,5805,20,60,-1,null,true,"This is not going to hurt... but it might tickle.","<Killcount>A LeBlanc:525:Unknown"),
    JALREK_JAD("JalRek-Jad","JalRek-Jad",NpcID.JALREKJAD,ItemID.JALREKJAD,Lists.newArrayList(33012),1,7589,8857,8857,20,-10,-1,null,true,"Small, troublesome, cute.","<Killcount>A LeBlanc:525:Unknown"),

    //Guantlet
    YOUNGLLEF("Youngllef","Youngllef",NpcID.YOUNGLLEF,ItemID.YOUNGLLEF,Lists.newArrayList(38596),1,8417,8428,8428,25,-1,-1,null,true,"Looks like a bit of a nightmare.","<Killcount>Design Sir:4246: May 19, 2022"),
    CORRUPTED_YOUNGLLEF("Corrupted Youngllef","Corrupted Youngllef",NpcID.CORRUPTED_YOUNGLLEF,ItemID.CORRUPTED_YOUNGLLEF,Lists.newArrayList(38597),1,8417,8428,8428,25,-1,-1,null,true,"Looks like a bit of a nightmare.","<Killcount>Design Sir:4246: May 19, 2022"),

    //corp
    DARK_CORE("Dark core","Dark core",NpcID.DARK_CORE,ItemID.PET_DARK_CORE,Lists.newArrayList(11069),1,7980,2417,2417,83,30,30,null,true,"Isn't so annoying when in pet form.\n","<Killcount>Flikker:36413:June 28, 2022"),
    ...
    //mole
    BABY_MOLE("Baby Mole","Baby Mole",NpcID.BABY_MOLE,ItemID.BABY_MOLE,Lists.newArrayList(42012),1,3309,3313,3313,90,30,30,null,true,"Keep Molin', molin' molin' molin'!\n","<Killcount>Ez Klaplong:21931:October 22, 2020"),
    ...
    //Sarachnis
    SRARACHA("Sraracha","Sraracha",NpcID.SRARACHA,ItemID.SRARACHA,Lists.newArrayList(37292),1,8320,8319,8319,48,30,30,null,true,"Good thing there's no such thing as Sarachnophobia.","<Killcount>Nosevesey:17000:June 6, 2022"),
